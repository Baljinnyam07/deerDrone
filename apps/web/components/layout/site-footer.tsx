...
export function SiteFooter() {
  return (
    <footer className="bg-white border-top border-primary border-4 pt-5 pb-3 mt-5">
      <div className="container">
        <div className="row g-4">
          {/* Brand column */}
          <div className="col-12 col-md-3">
            <Link className="d-flex align-items-center text-dark text-decoration-none mb-3" href="/">
              <img alt="DEER droneshop" src="/assets/brand/deer-logo.svg" height="40" className="me-2" />
            </Link>
